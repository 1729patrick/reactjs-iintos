...
export default function About() {
  return (
    <Container>
      ...
      <br />
      <p>
        The aim of our project is to develop international teaching and learning
        processes that lead our main target groups, teachers, students and
        schools stakeholders, able to make the schools more international and at
        the same time raise the competence levels in STEM education. For this
        purpose, an international office in school is the way to encourage,
        facilitate, help and promote the internationalization of the school at
        the national, European and international level.
      </p>
      Thus, we are developing a framework of international offices in schools
      for students and teachers, to generalize throughout Europe, to realize the
      ...
      <ul>
        ...
        <li>The organization of exchanges activities in two pilot schools.</li>
      </ul>
      <p>
        ...
        transversal to European curricula and there is a need to increase pupils
        competences on this key subjects.
      </p>
      <p>
        ...
        their own schools, organizing, monitoring, interacting and establishing
        new partnerships with the schools actors and the others coordinators in
        their country or across Europe.
      </p>
      <p>
        This TMS manages: coordinators contacts, schools, exchanges with others
        coordinators, tasks such as phone calls, e-mails, notes and meetings,
        campaigns, e-mailings, newsletters, workflows, documents.
      </p>
      <h4>In Conclusion</h4>
      <p>
      ...
      <p>
        With this project, we want to help all the European countries to develop
        the internationalization of their schools, to establish sustainable
        partnerships with others schools and to build and manage an
        international office in their schools without spending money.
      </p>
      <img
        src="~/images/erasmusCoFunded.jpg"
        width="400"
        height="121"
        alt="Erasmus Co Funded"
      />
      <img
        src="~/images/erasmusFlag.png"
        width="400"
        height="121"
        alt="Erasmus Flag"
      />
