...
const partners_ = [
  ...
  science and culture.`,
    all: ` Created in 1979, IPS is a public institution of higher education
  seeking, permanently and in association with its social partners, to
  contribute to the development of society, in general, and of the
  Setúbal region, in particular, through tertiary training activities,
  research and services provision, contributing to the creation,
  development, dissemination and transfer of knowledge, as well as the
  ...
  professionals with high technical and scientific expertise, offering
  32 bachelor degrees and 21 master degrees, besides post-secondary
  training (CTeSP) and post-graduation diplomas.

  IPS comprises 5 Schools in the areas of Education, Technology,
  Business & Administration and Health, that are distributes in two
  campi (in Setúbal and Barreiro). The institution has well-equipped
  laboratories, documentation centres, audio-visual equipment and
  computer facilities, which are available to its students and academic
  and non-academic staff.

  IPS integrates research and development, as well as knowledge and
  technology transfer as an indispensable part of its action, not only
  as a support to its training activities, but also as a way of
  interaction and commitment with its community, providing consulting,
  research and auditing services. In this scope, IPS has created an
  innovation, R&D and entrepreneurship support office (UAIIDE) that
  fully assists researchers, entrepreneurs, students and the regional
  community in their activities and projects.

  Also, the institution has the strategic goal to be an open and
  international community, being strongly committed with establishment
  of international partnerships and alliances. At this level, the
  institution has an international office (CIMOB-IPS) which provides
  support to mobility and international cooperation. There are several
  bilateral agreements established not only with European higher
  education institutions, but also with South American and Asian
  organizations, that have been allowing a fruitful exchange of students
  and staff. In what refers to project cooperation, IPS is presently
...
`,
  ...
  the best universities in the world, according to international rankings`,
    all: `Palacký University Olomouc is a university with long-standing
  tradition. Founded in 1573, it is the oldest university in Moravia and
  the second-oldest university in the Czech Republic. Palacký University
  Olomouc categorises itself as a scientific university. The eight
  faculties (Theology, Medicine and Dentistry, Arts, Science, Education,
  Physical Culture, Law, Health Sciences) of Palacký University offer
  332 Bachelor’s, Master’s, and Doctoral.

  Palacký University Olomouc is one of the top Czech universities, and
  ranks among the best universities in the world, according to
  international rankings (). Palacký University has more research centres - Institute of
  Molecular and Translational Medicine, The Regional Centre for Advanced
  Technologies and Materials, Centre for the Haná Region for
  Biotechnical and Agricultural Research, Research Centre for German
  Moravian Literature, Centre for Patristic, Medieval and Renaissance
  Texts, Centre for Clinical Law Education.
  ...
  teaching careers or other positions in education. This is done in
  cooperation with the other faculties of Palacký University but the
  priority is the development of education in the region of Olomouc and
  in providing qualification of graduates for positions outside the
  national borders.

  The Faculty of Education of the Palacký University in Olomouc provides
  university education for future teachers and other educationists
  destined for various types of kindergartens, primary and secondary
  schools, and school and after-school education facilities. It also
  focuses on training staff in the field of state administration and
  self-government. The faculty offers an established range of accredited
  Bachelor, Master’s and Doctoral programmes in teaching as well as
  related non-teaching fields, as full-time or part-time studying
  programmes.
  ...
  social studies. The Institute offers courses in theory of education
  and educational disciplines to prospective teachers at primary and
  secondary schools. The main research areas are Future Teachers
  training, 21st Century Skills in Education, Ethics in Education. the
  Institute is in charge of the doctoral programme of Education,
  supervises the habilitation and professorships procedures. The
  Institute and its faculty have been among the university’s most
  successful applicants for research grants aimed primarily at the
  innovation of study programmes, introducing new majors or new forms of
  study. The titles of the projects can serve as examples: The
  preparation for the acquisition of teaching licensure; Evaluation
  pedagogic research and its methods; The operational ﬁeld of social
  work – the background and the aim of the study; Research of new
  methods in creative competitions for youth aiming at motivating for
  research in natural sciences. The Institute has also an extensive
  collaboration with other institutions both Czech and from abroad
  (Slovakia, Spain, the Netherlands, Portugal, Hungary, Belgium, China,
  Indonesia, Austria, Germany, England, Poland etc.). Further, it is a
...
`,
  ...
  Intervention (ETPI) project since 2009.`,
    all: `The Group of Schools José Saramago
  with about 736 students is inserted in the territory belonging to the
  Municipality of Palmela, Setúbal District (about 40 KM, south of
  Lisbon). It is integrated in an Educational Territory of Priority
  Intervention (ETPI) project since 2009.
  ...
  Economics.`,
    all: `  The IIS “Vallauri” is a secondary school with more than 2,200 students
  and 150 teachers and was founded in 1962. It is the biggest secondary
  school for science and technology in the Cuneo Province and offers a
  wide range of courses: ICT, Applied Sciences, Energy, Mechatronics and
  Economics.
