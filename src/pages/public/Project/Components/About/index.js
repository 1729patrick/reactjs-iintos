...
export default function About() {
  return (
    <Container>
      ...
      >
        <p>
          IINTOS is a KA2 ERASMUS+ project, with grant Agreement
          2017-1-PT01-KA201-035947, named Implementation of International
          Offices in Schools (IINTOS). The aim of this project was to develop
          international teaching and learning processes that lead our main
          target groups, teachers, students and schools stakeholders, able to
          make the schools more international and at the same time raise the
          competence levels in, for example, STEM education. For this purpose,
          an international office in school is the way to encourage, facilitate,
          help and promote the internationalization of the school at the
        ...
        <ExpansionPanel>
          ...
          <ExpansionPanelDetails>
            <span>
              <ul>
                <li>
                  Comparison of curricula and the way to develop the European
                  and international dimension in the curriculum;
                </li>
                <li>
                  The definition and the development of the coordinator
                  activities in every international office in school;
                </li>
                <li>
