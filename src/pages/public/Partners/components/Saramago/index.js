  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Prevention of early withdrawal and prevention of indiscipline creating
          the office of student support, study rooms and a system of tutors
        </li>
        <li>
        ...
        <li>
          Improved relationships with families by facilitating the dissemination
          and contact with families about the work and projects that their
      ...
      <p>
        Alternative Curricular Paths (PCA) which aims at responding to the needs
        of a group of students who can’t acquire the basic skills within the
